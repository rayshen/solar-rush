...
// NASA/JPL approximate heliocentric elements and rates, J2000 ecliptic frame.
// Source: https://ssd.jpl.nasa.gov/planets/approx_pos.html
// Each array is [a (au), e, I, mean longitude, longitude of perihelion, longitude of ascending node].
// Rates are per Julian century; the fit is intended for 1800–2050 AD.
export const planetEphemerisElements = {
  mercury: {
...
export const bodies = [
  ...
  },
  {
    ...
    radiusKm: 5.5,
    mass: '2.2 x 10^14 kg',
    distanceKm: 2_682_000_000,
    orbitDays: 27_725,
    rotationHours: 52.8,
    axialTilt: 0,
    inclination: 162.19053,
    eccentricity: 0.9679359957,
    color: '#bcecff',
    scaleRadius: 0.22,
    orbitRadius: 25.8,
    speedKmS: 54.55,
